...
class InputDlg(QDialog):
	def __init__(self,parent=None):
		...
		nameButton.clicked.connect(self.slotName)
		sexButton.clicked.connect(self.slotSex)
		ageButton.clicked.connect(self.slotAge)
		statureButton.clicked.connect(self.slotStature)
	...
	def slotAge(self):
		age,ok=QInputDialog.getInt(self,self.tr("年龄"),
								   self.tr(" 请输入年龄"),
